...
    const links: Link[] = [];
    const episodeList: Episode[] = []; // यह अब भी खाली रहेगा, episodesLink का उपयोग करके बाद में भरा जाएगा

    // --- Download Links Extraction (आपके दूसरे कोड से) ---
    if (type === "series") {
        ...
        content.find("h3").each((_, h3) => {
            ...
            // V-Cloud link ढूंढें, जो अगले <p> टैग में हो सकता है
            const vcloudLink = $(h3)
                .nextUntil("h3, hr")
                .find("a")
        ...
        // vgmLinks पर, Movie लिंक्स आमतौर पर h3 या h5 के नीचे होते हैं। हम h3 और h5 दोनों को लक्षित करेंगे।
