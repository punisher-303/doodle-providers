...
const getStream = (_a) => __awaiter(void 0, [_a], void 0, function* ({ link: id, type, providerContext, }) {
    ...
    try {
        ...
        const tmdbId = (_d = (_c = (_b = payload.tmdbId) !== null && _b !== void 0 ? _b : payload.id) !== null && _c !== void 0 ? _c : payload.tmdId) !== null && _d !== void 0 ? _d : "";
        const season = (_e = payload.season) !== null && _e !== void 0 ? _e : "";
        const episode = (_f = payload.episode) !== null && _f !== void 0 ? _f : "";
        const effectiveType = (_h = (_g = payload.type) !== null && _g !== void 0 ? _g : type) !== null && _h !== void 0 ? _h : "movie";
        yield getRiveStream(String(tmdbId), episode, season, effectiveType, streams, providerContext);
        return streams;
    }
    catch (err) {
        console.error(err);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(servers.map((server) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                //   });
                // }
                (_b = (_a = res.data) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.sources.forEach((source) => {
                    Streams.push({
