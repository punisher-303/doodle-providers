            ...
            if (meta.type === "series") {
                (_h = (_g = data === null || data === void 0 ? void 0 : data.meta) === null || _g === void 0 ? void 0 : _g.videos) === null || _h === void 0 ? void 0 : _h.map((video) => {
                    ...
                    season.get(video === null || video === void 0 ? void 0 : video.season).push({
                        ...
                        type: "series",
                        link: `${(_a = data === null || data === void 0 ? void 0 : data.meta) === null || _a === void 0 ? void 0 : _a.imdb_id}-${(_b = video === null || video === void 0 ? void 0 : video.id) === null || _b === void 0 ? void 0 : _b.split(":")[1]}-${(_c = video === null || video === void 0 ? void 0 : video.id) === null || _c === void 0 ? void 0 : _c.split(":")[2]}`,
                    });
                });
                    ...
                    directLinks: [
                        {
                            title: "Movie",
                            type: "movie",
                            link: `${(_k = data === null || data === void 0 ? void 0 : data.meta) === null || _k === void 0 ? void 0 : _k.imdb_id}-`,
                        },
                    ],
                });
            }
