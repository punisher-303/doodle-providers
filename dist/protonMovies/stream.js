...
const getStream = function (_a) {
    return __awaiter(this, arguments, void 0, function* ({ link, providerContext, }) {
        ...
        function generateMessageToken(baseUrlL) {
            const hostname = baseUrlL === null || baseUrlL === void 0 ? void 0 : baseUrlL.replace(/https?:\/\//, "").split("/")[0];
        ...
        try {
            ...
            const idList = [];
            const id1080 = (_g = $('tr:contains("1080p")')
                .find('button:contains("Info")')
                .attr("id")) === null || _g === void 0 ? void 0 : _g.split("-")[1];
            if (id1080) {
                idList.push({
                    id: id1080,
                    quality: "1080p",
